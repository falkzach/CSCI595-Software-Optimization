...
void merge_sort(unsigned long*source, const unsigned long n, const unsigned long k, unsigned long*buffer) {
    if (n <= k) {
    ...
    merge_sort(source, n/2, k, buffer);
    merge_sort(source_2, n-n/2, k, buffer);
